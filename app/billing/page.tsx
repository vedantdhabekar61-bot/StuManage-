...
export default function BillingPage() {
  ...
  const handlePayment = async () => {
    ...
    if (typeof window === 'undefined' || !window.Razorpay) {
      show('Payment gateway is still loading. Please try again in a moment.', 'error');
      return;
    }
    ...
    try {
      ...
      rzp.on('payment.failed', function (response: any) {
        ...
        show('Payment failed or was cancelled.', 'error');
      });
  ...
  return (
    <>
      {/* Properly load Razorpay using Next.js Script */}
      <Script 
            ...
            <div className="relative z-10">
              ...
              <ul className="mb-10 space-y-5">
                {[
                  ...
                  'Automated Expiry Tracking', // Replaced Analytics
                  'Seat Allocation Management', // Replaced Priority Support
                  'Real-time Dashboard Metrics' // Replaced Cloud Sync
                ].map((feature) => (
